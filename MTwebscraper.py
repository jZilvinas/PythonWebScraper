...
print('Multi-threaded webscraper collecting data from {}... Please wait..'.format(main_url))


PlaystationsUrls(psUrls)

t= Thread(target=run, args=(psUrls,theList,))
t.start()
threads.append(t)

t= Thread(target=run2, args=(psUrls,theList,))
t.start()
threads.append(t)
...
print()
print('Multi-threaded webscraper done. Games data saved in {}.'.format(jsonFileName))
